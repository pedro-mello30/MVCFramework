...
class Manage:
	...
	def define_path(self):
		...
		self.path_model = os.path.abspath('%s/Models/%s_Model.php' %(self.app, self.name[0].upper() + self.name[1:]))
		self.path_controller = os.path.abspath('%s/Controllers/%sController.php' %(self.app, self.name[0].lower() + self.name[1:]))
		self.path_view = os.path.abspath('%s/Views/%s/index.phtml' %(self.app, self.name[0].upper() + self.name[1:]))
