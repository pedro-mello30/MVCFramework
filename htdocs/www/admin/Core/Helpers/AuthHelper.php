...
class AuthHelper
{
	...
	private $_redir;
	private $_bd;
	private $_tableName	     	= 'admin_users';
	private $_userColumn		= 'username';
	private $_senhaColumn		= 'password';
	private $_userNameColumn;
	private $_user;
	private $_senha;
	private $_controllerLogado 	= 'home';
	private $_actionLogado 		= 'index';
	private $_controllerErro    = 'home';
	...
	{
		//DEFINO A STRING DE COMPARAÇÃO
		$where = $this->_userColumn . " = '" . $_SESSION['user'] . "' AND " . $this->_senhaColumn . " = '" . $_SESSION['dados_usuario'][$this->_senhaColumn] . "'";
		//FAZ A CONSULTA
