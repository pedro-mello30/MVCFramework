...
var Serializer   = require('http2/lib/protocol/framer').Serializer;
var Deserializer = require('http2/lib/protocol/framer').Deserializer;
var Compressor   = require('http2/lib/protocol/compressor').Compressor;
var Decompressor = require('http2/lib/protocol/compressor').Decompressor;
var Connection   = require('http2/lib/protocol/connection').Connection;
